package com.example.graduationproject.ui.exhibits;
...
public class ExhibitsFragment extends Fragment {
    ...
    private ExhibitsViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = new ViewModelProvider(this).get(ExhibitsViewModel.class);
